...
const professionalActions = [
  { icon: Calendar, label: 'الجدول', href: '/worker/schedule', gradient: 'rgba(59,130,246,0.10) 0%, rgba(96,165,250,0.10) 100%', border: 'rgba(59,130,246,0.20)', iconColor: '#60A5FA', badge: null },
  { icon: MessageSquare, label: 'الرسائل', href: '/worker/messages', gradient: 'rgba(255,138,0,0.10) 0%, rgba(255,184,0,0.10) 100%', border: 'rgba(255,138,0,0.20)', iconColor: '#FF8A00', badge: '2' },
  { icon: Wallet, label: 'المحفظة', href: '/worker/wallet', gradient: 'rgba(16,185,129,0.10) 0%, rgba(52,211,153,0.10) 100%', border: 'rgba(16,185,129,0.20)', iconColor: '#10B981', badge: null },
  { icon: ImageIcon, label: 'المعرض', href: '/worker/gallery', gradient: 'rgba(168,85,247,0.10) 0%, rgba(192,132,252,0.10) 100%', border: 'rgba(168,85,247,0.20)', iconColor: '#C084FC', badge: null },
]
