      ...
      >
        ...
        <div className="flex flex-col items-start self-stretch overflow-hidden relative rounded-[28px] p-6 border border-white/8 backdrop-blur-[6px] bg-bg-elevated">
          <div className="flex justify-between items-center self-stretch relative gap-4">
            ...
            <div className="flex flex-col items-end gap-2" style={{ maxWidth: '200px' }}>
              ...
              {isAvailable && (
                <div className="flex justify-end items-start rounded-full px-3 py-[7.5px] border border-[rgba(34,197,94,0.20)] bg-[rgba(34,197,94,0.10)]">
            ...
            <div className="flex justify-between items-center self-stretch">
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col items-end gap-[0.5px]">
                  ...
                  <span className="text-[10px] font-bold leading-[15px] text-right text-[#94A3B8] tracking-[1px] uppercase">
                    الموعد القادم
                  </span>
                </div>
